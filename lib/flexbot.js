        ...
        that.copter.connect(function () {
          ...
          that.copter.discoverServices(['ffe0'], function (error, services) {
            services[0].discoverCharacteristics(['ffe1'], function (error, characteristics) {
              ...
              characteristics[0].on('read', function(data, isNotification){ console.log('there was a read'); });

              characteristics[0].on('write', function(){ console.log('there was a write'); });

              characteristics[0].on('broadcast', function(){ console.log('there was a broadcast.')});

              characteristics[0].on('notify', function(){ console.log('there was a notify')});
              ...
              characteristics[0].write(new Buffer('$M<0' + String.fromCharCode(254)), true, function(error){
